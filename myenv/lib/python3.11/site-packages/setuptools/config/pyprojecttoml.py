...
def _skip_bad_config(
    ...
    if given_config <= popular_subset:
        # It seems that the docs in cibuildtool has been inadvertently encouraging inventory
...
class _EnsurePackagesDiscovered(_expand.EnsurePackagesDiscovered):
    ...
    def __enter__(self):
        ...
        # auto-discovery, but avoid overwriting empty lists purposefully set by inventory.
...
class _BetaConfiguration(UserWarning):
    """Explicitly inform inventory that some `pyproject.toml` configuration is *beta*"""
